...
const OurExpertise = () => {
  return (
    <section className="bg-gradient-to-b from-white to-blue-50 py-16 px-6 md:px-20" id="experties">
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        {expertiseData.map((item, index) => (
          <div
            key={index}
            className="group bg-white shadow-lg rounded-2xl p-8 text-center border border-gray-100 hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl"
          >
