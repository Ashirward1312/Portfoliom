...
const rolesData = [
  ...
  {
    Icon: FaBuilding,
    title: "RealX Co-Ownership",
    subtitle: "Fractional Ownership & PropTech Innovation",
    bullets: [
      {
        Icon: FaChartLine,
        text: "Structured co-ownership investment models",
      },
      {
        Icon: FaHandshake,
        text: "Investor onboarding & partnership frameworks",
      },
      {
        Icon: FaLightbulb,
        text: "Education on new-age digital ownership",
      },
    ],
  },
  
  {
    ...
    subtitle: "Strategic Growth & Alliances",
    bullets: [
      {
        Icon: FaHandshake,
        text: "Channel partner & broker network development",
      },
      {
        Icon: FaChartLine,
        text: "Launch, pricing & go-to-market strategy",
      },
      {
        Icon: FaMapMarkedAlt,
        text: "Corporate, NRI & institutional tie-ups",
      },
    ],
  },
];
