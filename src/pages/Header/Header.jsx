    ...
    >
      <div className="max-w-[1200px] mx-auto h-16 md:h-20 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-7">
          <nav className="flex items-center gap-7">
            {nav.map((item) => (
              <a
                ...
                href={item.href}
                onClick={(e) => handleNavClick(e, item.href)}
                className="group relative text-neutral-300 hover:text-neutral-50 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-100/40 rounded"
              >
                {item.label}
          ...
          {/* Desktop Contact Us CTA - white button */}
          <button
            type="button"
            onClick={scrollToContact}
      ...
      {open && (
        <div className="md:hidden border-t border-white/10 bg-neutral-950">
          <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-3">
            ...
            {/* Mobile Contact Us CTA - white button */}
            <button
              type="button"
              onClick={scrollToContact}
